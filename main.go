...
func main() {
	...
	img := profile.GetRandomImage()
	if err := run("git", "-c", "user.name=SummerSec", "-c", "user.email=SummerSec@users.noreply.github.com", "commit", "-a", "-m", fmt.Sprintf("%s Generated by actions", img)); err != nil {
