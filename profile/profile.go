...
`, "os.gif"))); err != nil {
	...
	if p.config.TwitterUsername != "" {
		twitterLink := fmt.Sprintf("![GitHub Followers](https://img.shields.io/github/followers/SummerSec.svg?style=social&label=Follow) \n [![Follow on Twitter](https://shields.io/twitter/follow/%s?label=Follow)](https://twitter.com/%[1]s) ", p.config.TwitterUsername)
